...
from network_agent_rag.packs.networkops.agents.multi_agent.report_agent import run_report_agent
...
from network_agent_rag.packs.networkops.agents.multi_agent.supervisor import (
    next_agent,
