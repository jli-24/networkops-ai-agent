...
from network_agent_rag.agents import DiagnosisPlan, query_interface, query_logs
from network_agent_rag.agents.multi_agent import (
    MultiAgentState,
    SupervisorPlan,
    create_multi_agent_workflow,
)
from network_agent_rag.domain import NetworkTopology
...
_KNOWLEDGE_PATH = (
    _PROJECT_ROOT / "knowledge" / "diagnosis" / "optical_module_degradation.md"
)
